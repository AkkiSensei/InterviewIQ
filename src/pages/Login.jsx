...
import { FaEnvelope, FaLock, FaArrowRight, FaSpinner, FaGoogle } from 'react-icons/fa';
...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    ...
    // Simulate a Google popup loading delay
    setTimeout(() => {
      loginMock('alex.mercer@gmail.com');
    ...
    <div className="relative min-h-[580px] flex items-center justify-center py-6">
      ...
      >
        ...
        <button
          ...
          className="w-full py-3.5 rounded-xl bg-white hover:bg-gray-100 font-bold text-sm text-gray-900 transition duration-200 flex items-center justify-center gap-2.5 cursor-pointer shadow-md"
        >
